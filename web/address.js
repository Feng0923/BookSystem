...
list2[list2.length] = new Array("北京市", "东城区", "西城区", "崇文区", "宣武区", "朝阳区", "丰台区", "石景山区", " 海淀区（中关村）", "门头沟区", "房山区", "通州区", "顺义区", "昌平区", "大兴区", "怀柔区", "平谷区", "密云县", "延庆县", " 其他");
...
for(var i =0;i<list1.length; i++)
{
    ...
    // $("#province").append("<option value=\""+list1[i]+"\">"+list1+"</option>");
    //city initialize
    ...
    for (var j = 0; j < firstprovince.length; j++) {
        ...
        // $("city").append("<option value=\""+firstprovince[j]+"\">"+firstprovince[j]+"</option>");
    }
}
...
function selectprovince(obj) {
    ...
    for(var i =0;i<list2element.length; i++)
    {
        ...
        // $("city").append("<option value=\""+list2element[i]+"\">"+list2element[i]+"</option>");
    }
    $(".selectpicker").selectpicker("refresh");
    $(".selectpicker").selectpicker("render");
}
